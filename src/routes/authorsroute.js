...
authorsRouter.post('/add', function (req, res) {
    ...
    var item={
        ...
        image:req.body.image,  //put image instead of images  part2 point8
...
authorsRouter.post('/delete', function (req, res) {   //change post to delete part2 point9
...
authorsRouter.post('/update', function (req, res) {          //change it to put part2 point9
